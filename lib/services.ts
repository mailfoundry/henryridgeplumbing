...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "I handle the complete bathroom installation from start to finish. That means strip-out, new pipework, suite fitting, and finishing. Whether you want a simple refresh or a full redesign, you'll get a bathroom you're proud of — fitted properly, no shortcuts.",
    features: [
  ...
  },
  {
    ...
    description:
      "Good tiling transforms a room. I tile to a high standard — straight lines, consistent grout, properly waterproofed. Wall tiling for bathrooms and kitchens, floor tiling for any room, and full bathroom tiling packages combined with installation.",
    features: [
  ...
  },
  {
    ...
    description:
      "From a simple dripping tap to a full shower installation, I handle all small-to-medium plumbing jobs professionally. No job is too small — and everything is done cleanly and correctly first time.",
    features: [
  ...
  },
  {
    ...
    description:
      "Blocked drains are a nuisance — and left untreated, they get worse. I clear blockages in sinks, baths, toilets and outdoor drains, diagnosing the cause so the problem doesn't keep coming back.",
    features: [
  ...
  },
  {
    ...
    description:
      "Want an extra radiator in a room that's always cold? Replacing an old, inefficient rad? I handle the water-side work — fitting new radiators, replacing valves, and bleeding the system — all neatly and reliably.",
    features: [
  ...
  },
  {
    ...
    description:
      "An outdoor tap is one of the most useful additions to any home. I install garden taps professionally, with a proper isolation valve so you can turn it off in winter, and a tidy finish through the external wall.",
    features: [
